...
const ru = {
  ...
  start: {
    ...
    playWithFriend: "Создать комнату",
  ...
  duel: {
    ...
    waitingTitle: "Ждем друга...",
    publicWaitingTitle: "Ищем соперника...",
    shareLink: "Отправьте эту ссылку второму игроку:",
    publicSearch: "Подключим первого свободного игрока",
    cancelSearch: "Отмена",
    copied: "Скопировано!",
...
const en: Messages = {
  ...
  duel: {
    ...
    publicWaitingTitle: "Finding opponent...",
    shareLink: "Send this link to the second player:",
    publicSearch: "We will connect the first available player. This usually takes a few seconds.",
    cancelSearch: "Cancel",
    copied: "Copied!",
    copyLink: "Copy link",
    draw: "Draw",
